                    ...
                    <div class=col-12>
                        ...
                        <nav>
                            <ol class=breadcrumb >
                                ...
                                {{-- <li class="breadcrumb-item active"><span>Danh mục</span> --}}
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                @if(isset($subCategory) && $subCategory->count() > 0 )
                                  ...
                                  @else
                                    @foreach ($banners as $item)
                                        @if($item->type == 'banner-do-dien-lanh' || 
                                        $item->type =='banner-tivi' || 
                                        $item->type =='banner-dien-gia-dung' || 
                                        $item->type =='banner-dien-thoai' || $item->type =='banner-laptop' ||
                                        $item->type =='banner-thiet-bi')
                                          <div class="item banner-item banner-item-1">
                                            <a href=# data-id=3983>
                                                <picture>
                                                    <source srcset="{{ sc_file($item->image) }}" type=image/jpeg>
                                                    <img src="{{ sc_file($item->image) }}" alt="" width=396 height=185>
                                                </picture>
                                            </a>
                                          </div>
                                        @endif
