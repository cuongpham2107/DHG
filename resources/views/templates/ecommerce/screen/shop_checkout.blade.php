    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12" style="margin-top: 30px">
                <h5 style="font-size: 2.2rem;"><i class="fa fa-shopping-bag" aria-hidden="true"></i> Thanh toán</h5>
            </div>
            ...
            <form class="sc-shipping-address" id="sc_form-process" role="form" method="POST" action="{{ sc_route('checkout.process') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table table-borderless table-responsive order-checkout" style="display:inline-table;">
                            <tr width=100%>
